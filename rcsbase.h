...
#if !ANSI_INCLUDE_FILES
/* these are really "posix_include_files" but who's counting? */
	/* <sys/wait.h> */
#	if has_sys_wait_h
#		include <sys/wait.h>
#	endif
...
#if AKP_MODES
#define WORKMODE(RCSmode, writable) ((RCSmode)&~(S_IWRITE) | ((writable)?S_IWRITE:0))
#else
...
#if bad_unlink
int un_link P((const char *a));
#  define unlink(a) un_link(a)
#endif
